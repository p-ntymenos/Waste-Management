...
<div class="row breadcrumps">
    <div class="col-xs-12">
        <p><i class="icon gicon-envelope-90"></i>ΕΙΔΟΠΟΙΗΣΕΙΣ</p>
    </div>
</div>
...
<div class="section no-bt-padding">
    <div class="row">
        <div class="col-sm-6 col-xs-12">
            <h4 class="sec-head no-icon">ΕΙΔΟΠΟΙΗΣΕΙΣ</h4>
        </div>
        <div class="col-sm-6 col-xs-12">
            <a class="newnotification pull-right" href="{{url('/adminnotifications/create')}}">ΔΗΜΙΟΥΡΓΙΑ ΕΙΔΟΠΟΙΗΣΗΣ</a>
        </div>
    </div>
</div>
...
-->
                                    ...
                                    <tr>
                                        <td>
                                            <b>{!! link_to('notifications/' . $thread->id, $thread->subject) !!}</b><br>
