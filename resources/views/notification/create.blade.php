...
<div class="row breadcrumps">
    <div class="col-xs-12">
        <p><i class="icon gicon-envelope-90"></i>Ειδοποιήσεις / Δημιουργία Νέας Ειδοποίησης</p>
    </div>
</div>
<!-- =========================== /BREADCRUMBS =========================== -->
...
<div class="section no-bt-padding">
    <div class="row">
        <div class="col-xs-12">
            <h4 class="sec-head"><i class="icon gicon-my-profile-edit"></i>ΔΗΜΙΟΥΡΓΙΑ ΕΙΔΟΠΟΙΣΗΣ</h4>
        </div>
        <div class="col-xs-12">
            <div class="users-back">
                <a href="{{url('adminnotifications')}}" class="arrow-left"><i class="icon gicon-arrow-down"></i><span class="prev">Πίσω στις Ειδοποιήσεις</span></a>
            </div>
        </div>
    </div>
</div>
