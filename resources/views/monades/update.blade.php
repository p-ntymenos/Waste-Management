...
<div class="section top25">
    ...
    {!! Form::model($monada,['method' => 'PATCH', 'action' =>  ['MonadesController@update', $monada->id],  'id'=>'form-newuser' ])!!}
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 top80">
            <input type="text" name="kafsis_code" class="col-lg-5 col-md-5 col-sm-12 col-xs-12" value="{{$monada->kafsis_code}}">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 top80">
            <input type="text" name="name" class="col-lg-5 col-md-5 col-sm-12 col-xs-12" value="{{$monada->name}}">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 top80">
            <input type="text" name="proc_type" class="col-lg-5 col-md-5 col-sm-12 col-xs-12" value="{{$monada->proc_type}}">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 top80">
            <div class="checkbox " title="Category 1">
                <input type="checkbox" name="Cat1" value="1" id="role-category1" <?php if($monada->Cat1 == 1)echo "checked";?>> 
        ...
        <div class="col-md-3 top80">
            <div class="checkbox" title="Category 2">
                <input type="checkbox" name="Cat2" value="1" id="role-category2" <?php if($monada->Cat2 == 1)echo "checked";?>> 
        ...
        <div class="col-md-3 top80">
            <div class="checkbox" title="Category 3">
                <input type="checkbox" name="Cat3" value="1" id="role-category3" <?php if($monada->Cat3 == 1)echo "checked";?>> 
        ...
        <div class="col-md-3 top80">
            <div class="checkbox" title="Laspi">
                <input type="checkbox" name="Laspi" value="1" id="role-laspi" <?php if($monada->Laspi == 1)echo "checked";?>> 
        ...
        <div class="col-md-3 top80">
            <div class="checkbox" title="Fytika">
                <input type="checkbox" name="Fytika" value="1" id="role-fytika" <?php if($monada->Fytika == 1)echo "checked";?>> 
